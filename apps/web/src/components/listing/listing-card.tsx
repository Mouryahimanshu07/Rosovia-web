    ...
    <div className="group flex flex-col rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition hover:shadow-md hover:border-gray-350 justify-between">
      ...
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
        ...
        <Link
          ...
          className="text-xs font-semibold bg-gray-50 text-gray-600 hover:text-indigo-650 hover:bg-indigo-50 border border-gray-250 rounded px-2.5 py-1.5 transition-all"
        >
          Ask Creator
        </Link>
      </div>
