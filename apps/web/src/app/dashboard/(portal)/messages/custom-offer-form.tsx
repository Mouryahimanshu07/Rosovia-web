...
export function CustomOfferForm({ inquiryId }: CustomOfferFormProps) {
  ...
  return (
    <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50/60 to-purple-50/40 transition-all duration-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <div className="relative rounded-md shadow-sm">
              ...
              <input
                ...
                required
                min="1"
                className="w-full rounded-md border border-gray-300 pl-7 pr-3 py-1.5 text-sm text-gray-800 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 disabled:opacity-60"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              min="1"
              className="w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm text-gray-800 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 disabled:opacity-60"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            disabled={isPending}
            maxLength={1000}
            className="w-full rounded-md border border-gray-300 px-3 py-1.5 text-sm text-gray-800 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 resize-none disabled:opacity-60"
          />
        </div>
        ...
        <div className="flex justify-end gap-2">
          <button
            type="submit"
            disabled={isPending}
            className="rounded-md bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm px-4 py-2 text-xs font-bold transition disabled:opacity-50"
          >
