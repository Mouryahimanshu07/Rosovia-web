-- =============================================================================
-- Rosovia Step 33: Search Trust Fields
-- Migration: 041_search_trust_fields.sql
-- Purpose: Drop and recreate search_listings_ranked() RPC to return creator trust metrics (verification and ratings).
-- =============================================================================

-- Drop existing function with exact parameter list
...
returns table (
  ...
  creator_verification_level text,
  creator_rating_avg    numeric,
...
as $$
  with base as (
    select
      ...
      cp.verification_level      as verification_level,
      cp.rating_avg              as rating_avg,
      cp.rating_count            as rating_count,
  ...
  select
    ...
    b.verification_level                                   as creator_verification_level,
    b.rating_avg                                           as creator_rating_avg,
    b.rating_count                                         as creator_rating_count,
